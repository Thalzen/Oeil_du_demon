...
public class anim_public1 : MonoBehaviour
{
    public Material[] _Materials;
    public float framebrasenbas = 0.1f;

    public float frameanim = 0.05f;
    public float framebrasenlair = 0.5f;
    ...
    {
        yield return new WaitForSeconds(framebrasenbas);
        ...
        yield return new WaitForSeconds(frameanim);
        gameObject.GetComponent<Renderer>().material = _Materials[3];
